        ...
        >
            <div className="w-full border-1 border-solid rounded-t-lg">
                <div className="flex justify-between p-3 mt-8">
                    ...
                    {/* {
                        mobileMenuOpen ? "" : <div className="text-4xl font-extrabold mt-4" onClick={toggleMobileMenu}>
                        < CiMenuBurger />
                    </div>
                    } */}
                    ...
                    {/* Mobile Menu */}
                    <div
                        className={`lg:hidden fixed inset-0 z-10 w-full ${mobileMenuOpen ? "" : "hidden"
                            }`}
                    >


                        <div className="overflow-x-hidden flex flex-col items-center justify-center w-full h-screen text-white" style={{ backgroundColor: checked ? 'white' : 'rgb(31 41 55)', color: checked ? 'black' : 'white' }}>
                            <Link to="/" onClick={closeMobileMenu}>
                                <div className="text-2xl font-semibold my-2 hover:text-orange-500">
                                    Home
                                </div>
                            </Link>
                            ...
                            <Link to="RateMe">
                                <div className="hover:scale-110 transition-transform duration-2000 border-1 bg-orange-400 p-1 rounded-md text-white font-semibold flex flex-col hover:bg-orange-500 hover:cursor-pointer mt-2 w-28 text-2xl text-center" onClick={closeMobileMenu}>
                                    <div>Rate Me</div>
                            ...
                            <div className='mt-10 lg:w-20 hover:scale-110 transition-transform duration-2000'>
                                <button className='text-5xl' onClick={clickHandler}>{checked ? <TiAdjustBrightness className='text-orange-500 hover:text-black' /> : <PiMoonStarsBold className='text-black hover:text-orange-500' />}</button></div>

                            <div className="text-3xl font-extrabold mt-10 border-2 border-orange-300 rounded-full p-2 text-orange-300" onClick={toggleMobileMenu}><BsXLg /></div>
                        </div>
                    </div>
